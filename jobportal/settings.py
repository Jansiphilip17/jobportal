...
Supports both local (MySQL/SQLite) and Render (PostgreSQL) deployments.
"""
...
# ── Database ──
# On Render: set DATABASE_URL env var (PostgreSQL)
# Local: set DB_* vars in .env for MySQL, or leave blank for SQLite fallback
